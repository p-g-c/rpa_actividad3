(define (problem problema_hospital2) (:domain domain_hospital)
(:objects 
...
(:init
    ...
    (paciente_en_ubicacion Paciente1 L3)
    (paciente_en_ubicacion Paciente2 L5)
    (paciente_en_ubicacion Paciente3 L6)
    ...
    (enlace L1 L2) (enlace L2 L4) (enlace L4 L3)(enlace L4 L5)(enlace L2 L6)
    (enlace L2 L1) (enlace L4 L2) (enlace L3 L4)(enlace L5 L4)(enlace L6 L2)
